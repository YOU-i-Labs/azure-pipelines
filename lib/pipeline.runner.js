...
class PipelineRunner {
    ...
    start() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                this.taskParameters.azurePipelineId.forEach((element) => __awaiter(this, void 0, void 0, function* () {
                    let description = `(name="${this.taskParameters.azurePipelineName}", id=${element})`;
                    try {
                        core.debug(`Triggering Yaml pipeline : ${description}`);
                        yield this.RunYamlPipeline(webApi, element);
                    }
                    catch (error) {
    ...
    RunYamlPipeline(webApi, azurePipelineId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (buildQueueResult != null) {
                ...
                if (buildQueueResult.validationResults != null && buildQueueResult.validationResults.length > 0) {
                    ...
                    logger_1.Logger.LogPipelineTriggered(buildDefinition.name, projectName);
